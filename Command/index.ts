...
export type Command<T extends Document> = UpdateCommand<T> | CreateCommand<T> | DeleteCommand<T> | GetCommand<T> | ListCommand<T>

export namespace Command {
	export function is(value: any | Command<any>): value is Command<any> {
		return UpdateCommand.is(value) || CreateCommand.is(value) || DeleteCommand.is(value) || GetCommand.is(value) || ListCommand.is(value)
	}
